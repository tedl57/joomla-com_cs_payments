 ...
 * View to edit
 */
class Cs_paymentsViewPayproc extends JViewLegacy {
    ...
    public function display($tpl = null) {
        ...
        // control access to the component - must be logged in and able to edit or edit state
        $loggeduser = JFactory::getUser();
        $canEdit = $loggeduser->authorise('core.edit',	'com_cs_payments');
        $canEditState = $loggeduser->authorise('core.edit.state',	'com_cs_payments');
