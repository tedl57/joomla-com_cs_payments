 ...
 * View to edit
 */
class Cs_paymentsViewSource extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_CS_PAYMENTS_TITLE_SOURCE'), 'payment.png');//todos: payment.png -> source.png or none
